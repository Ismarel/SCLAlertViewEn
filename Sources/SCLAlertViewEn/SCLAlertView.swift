...
open class SCLAlertView: UIViewController {
    ...
    fileprivate func setup() {
        ...
        closeButton.frame = CGRect(x:appearance.kWindowWidth + 15, y: appearance.kWindowHeight, width: 30, height: 30)
        if let image = UIImage(named: "closeAlert") {
        ...
        let closeGesture = UITapGestureRecognizer(target: self, action: #selector(SCLAlertView.closeViewGesture))
    ...
    override open func viewWillLayoutSubviews() {
        ...
        contentView.layer.cornerRadius = appearance.contentViewCornerRadius
        closepX = appearance.kWindowWidth + 15
        closepY = y - 15
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(SCLAlertView.keyboardWillShow(_:)), name:NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(SCLAlertView.keyboardWillHide(_:)), name:NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil);
    }
    ...
    @objc func keyboardWillShow(_ notification: Notification) {
        ...
        self.closeButton.frame.origin.y = closepY - newContentViewFrameY
    }
    ...
    @objc func keyboardWillHide(_ notification: Notification) {
        if(keyboardHasBeenShown){//This could happen on the simulator (keyboard will be hidden)
            ...
            self.closeButton.frame.origin.y = closepY
